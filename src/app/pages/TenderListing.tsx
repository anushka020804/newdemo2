        ...
        <aside className="w-64 flex-shrink-0 sticky top-20 self-start space-y-5">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-3">
            ...
            <button
              ...
              className={`w-full text-left px-4 py-2.5 text-sm font-semibold rounded-xl transition-colors mb-1 ${
                activeTab === "all" ? "bg-[#4F46E5] text-white shadow" : "text-gray-600 hover:text-gray-900 hover:bg-gray-50"
              }`}
            >
              All Tenders
            </button>
            <button
              ...
              className={`w-full text-left px-4 py-2.5 text-sm font-semibold rounded-xl transition-colors ${
                activeTab === "matched" ? "bg-[#4F46E5] text-white shadow" : "text-gray-600 hover:text-gray-900 hover:bg-gray-50"
              }`}
            >
              My Tenders
            </button>
                ...
                >
                  <div className="flex items-start gap-4 flex-col sm:flex-row">
                    ...
                    <div className="flex-1 w-full">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mt-6 pb-6 border-b border-gray-100">
                        <div>
                      ...
                      <div className="flex flex-col sm:flex-row items-center justify-between mt-4 gap-4">
                        ...
                        <button
                          ...
                          className="w-full sm:w-auto bg-[#4F46E5] text-white px-6 py-2.5 rounded-xl hover:bg-[#4338CA] transition-colors font-semibold text-sm shadow-sm flex items-center justify-center gap-2"
                        >
                          View Tender
                ...
                >
                  <div className="p-5 pb-3">
                    <div className="flex items-center justify-between mb-4">
                      <span className="text-[10px] font-bold tracking-wider text-indigo-600 bg-indigo-50 px-2 py-1 rounded-md">
                        {tender.tenderNumber}
                      </span>
                      <span className={`px-2.5 py-0.5 ${statusConfig.bg} ${statusConfig.text} text-[10px] font-bold uppercase tracking-wider rounded-md border ${statusConfig.border}`}>
                        {statusConfig.label}
                      </span>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-xs text-gray-500 mt-1 truncate font-medium">{tender.organization}</p>
                      </div>
                    </div>
                  </div>
