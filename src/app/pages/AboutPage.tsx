...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-blue-50 font-sans text-gray-900 selection:bg-indigo-100 selection:text-indigo-900">
      {/* Navigation Bar */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            <a href="/" onClick={e => { e.preventDefault(); navigate("/"); }} className="text-sm font-medium text-gray-600 hover:text-indigo-600 transition-colors">Home</a>
            <a href="/about" className="text-sm font-medium text-indigo-600 transition-colors">About</a>
            <div className="relative group">
              <button className="text-sm font-medium text-gray-600 hover:text-indigo-600 transition-colors flex items-center gap-1 focus:outline-none">
                Products
              ...
              <div className="absolute left-0 mt-2 w-48 bg-white border border-slate-200 rounded-lg shadow-lg opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 pointer-events-none group-hover:pointer-events-auto group-focus-within:pointer-events-auto transition-opacity z-50">
                <a href="/metalcapital" className="block px-5 py-3 text-sm text-gray-700 hover:bg-indigo-50 hover:text-indigo-600 rounded-lg">Metal Capital</a>
              </div>
            </div>
          </div>
          <div className="flex items-center gap-4">
            <button onClick={() => navigate("/login") } className="text-sm font-medium text-gray-600 hover:text-indigo-600 transition-colors hidden sm:block">
              Log in
            </button>
            <button
              onClick={() => navigate("/signup")}
              className="bg-gradient-to-r from-indigo-600 to-blue-600 text-white px-5 py-2.5 rounded-xl text-sm font-medium hover:from-indigo-700 hover:to-blue-700 transition-all shadow-lg shadow-indigo-200 hover:shadow-xl hover:-translate-y-0.5"
            >
              Start Now
            </button>
          </div>
      ...
      <div className="max-w-7xl mx-auto pt-24 px-6">
        <section id="about" className="py-24 bg-gradient-to-br from-indigo-50 via-blue-50 to-white text-slate-900 rounded-3xl shadow-2xl border border-blue-100">
          <div className="max-w-3xl mx-auto px-4 text-center">
            <h2 className="text-4xl lg:text-5xl font-bold mb-4 bg-gradient-to-r from-indigo-600 to-blue-600 bg-clip-text text-transparent drop-shadow">About QistonPe</h2>
            ...
            <div className="grid md:grid-cols-2 gap-8 text-left mb-10">
              <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-7">
                <h3 className="text-lg font-semibold text-indigo-600 mb-2">Our Vision</h3>
                <p className="text-gray-700">To democratize access to business opportunities and working capital for every small manufacturer in India, enabling them to compete and thrive in the digital economy.</p>
              </div>
              <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-7">
                <h3 className="text-lg font-semibold text-indigo-600 mb-2">What We Do</h3>
              ...
              <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-7 md:col-span-2">
                <h3 className="text-lg font-semibold text-indigo-600 mb-2">Why QistonPe?</h3>
                <ul className="list-disc pl-5 text-gray-700 space-y-2">
