                        ...
                        {notifications.length === 0 ? (
                            ...
                            notifications.map((notification) => (
                                <div
                                    ...
                                    className={`px-5 py-4 border-b border-gray-50 hover:bg-gray-50 cursor-pointer transition-colors ${!notification.read ? "bg-indigo-50/50" : ""
                                        }`}
                                >
                                    <div className="flex gap-3">
                                        <div className={`w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 ${notification.type === "tender" ? "bg-indigo-100" :
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center gap-2 mt-1">
                                            <span className={`px-2 py-0.5 text-xs font-semibold rounded-full ${company.status === "verified" ? "bg-green-400/20 text-green-100" :
            ...
            <nav className="flex-1 p-4 space-y-1">
                ...
                <div>
                    <button
                        ...
                        className={`w-full flex items-center justify-between px-4 py-3 rounded-xl text-sm font-medium transition-all ${isTendersPage
                                ? "bg-violet-600 text-white shadow-lg shadow-violet-200"
                                : "text-gray-600 hover:bg-gray-100"
                            }`}
                    >
                        ...
                        {tendersExpanded && (
                            ...
                            >
                                <button
                                    ...
                                    className={`w-full text-left px-4 py-2.5 text-sm font-medium rounded-xl transition-all ${isTendersPage && activeTab === "all"
                                ...
                                <button
                                    ...
                                    className={`w-full text-left px-4 py-2.5 text-sm font-medium rounded-xl transition-all ${isTendersPage && activeTab === "matched"
                                            ? "bg-violet-100 text-violet-700 border-l-4 border-violet-600"
                                            : "text-gray-500 hover:bg-gray-50 hover:text-gray-700"
                                        }`}
                                >
                ...
                <button
                    ...
                    className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all ${isActive("/saved-bids")
                            ? "bg-violet-600 text-white shadow-lg shadow-violet-200"
                            : "text-gray-600 hover:bg-gray-100"
                        }`}
                >
                ...
                <button
                    ...
                    className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all ${isActive("/profile")
                            ? "bg-violet-600 text-white shadow-lg shadow-violet-200"
                            : "text-gray-600 hover:bg-gray-100"
                        }`}
                >
